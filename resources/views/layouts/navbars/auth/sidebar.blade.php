    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item pb-2">
                <a class="nav-link {{ Route::currentRouteName() == 'dashboard' ? 'active' : '' }}" wire:navigate
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'debts' ? 'active' : '' }}"
                    href="{{ route('debts') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1"
            ...
            {{-- <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'stores' ? 'active' : '' }}"
                    href="{{ route('stores') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1"
            ...
            {{-- <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'resellers' ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Resellers</span>
                </a>
            </li> --}}
            <li class="nav-item">
