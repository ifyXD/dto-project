    ...
    <div class="card shadow-lg ">
        <div class="card-header pb-0 pt-3 ">
            <div class="float-start">
                ...
                <h2 class="text-2xl font-bold mb-4">{{ $storeId ? 'Edit Store' : 'Create New Store' }}</h2>
            </div>
        ...
        <form wire:submit.prevent="{{ $storeId ? 'update' : 'store' }}" role="form text-left">
            <div class="card-body pt-sm-3 pt-0">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="store-name" class="form-control-label">{{ __('Store Name') }}</label>
                            <div class="@error('store_name') border border-danger rounded-3 @enderror">
                                <input wire:model="store_name" class="form-control" type="text"
                                    placeholder="Store Name" id="store-name">
                            </div>
                            @error('store_name')
                ...
                <div class="d-flex py-4">
                    ...
                    <button type="submit"
                        class="btn bg-gradient-secondary w-100 px-3 mb-2 ms-2 active">{{ $storeId ? 'Update' : 'Create' }}</button>
                </div>
